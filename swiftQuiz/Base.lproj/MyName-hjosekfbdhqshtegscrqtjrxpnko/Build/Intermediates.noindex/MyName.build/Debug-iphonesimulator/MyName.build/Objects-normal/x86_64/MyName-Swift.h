...
#ifndef MYNAME_SWIFT_H
#define MYNAME_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyName",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6MyName11AppDelegate")
...
SWIFT_CLASS("_TtC6MyName13SceneDelegate")
...
SWIFT_CLASS("_TtC6MyName14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbTitle;
- (void)viewDidLoad;
- (IBAction)btAnswer:(UIButton * _Nonnull)sender;
