...
#ifndef IMCSTORY_SWIFT_H
#define IMCSTORY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IMCStory",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8IMCStory11AppDelegate")
...
SWIFT_CLASS("_TtC8IMCStory13SceneDelegate")
...
SWIFT_CLASS("_TtC8IMCStory14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified peso;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified altura;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified viewResult;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified result;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageResult;
- (void)viewDidLoad;
