...
#ifndef MYEMOTION_SWIFT_H
#define MYEMOTION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyEmotion",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9MyEmotion11AppDelegate")
...
SWIFT_CLASS("_TtC9MyEmotion13SceneDelegate")
...
SWIFT_CLASS("_TtC9MyEmotion14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageMyface;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbResult;
- (void)viewDidLoad;
- (IBAction)btemotion:(UIButton * _Nonnull)sender;
