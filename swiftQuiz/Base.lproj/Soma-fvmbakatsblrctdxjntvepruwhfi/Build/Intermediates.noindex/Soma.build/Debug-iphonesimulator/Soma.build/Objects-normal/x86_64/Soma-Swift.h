...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Soma",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC4Soma11AppDelegate")
...
SWIFT_CLASS("_TtC4Soma13SceneDelegate")
...
SWIFT_CLASS("_TtC4Soma14ViewController")
...
- (void)viewDidLoad;
- (IBAction)lbResult:(UIButton * _Nonnull)sender;
