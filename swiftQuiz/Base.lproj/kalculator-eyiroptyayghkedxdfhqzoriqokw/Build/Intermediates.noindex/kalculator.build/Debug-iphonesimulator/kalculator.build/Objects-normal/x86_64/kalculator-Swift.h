...
#ifndef KALCULATOR_SWIFT_H
#define KALCULATOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="kalculator",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10kalculator11AppDelegate")
...
SWIFT_CLASS("_TtC10kalculator13SceneDelegate")
...
SWIFT_CLASS("_TtC10kalculator14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfnumber1;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tfnumber2;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbresult;
- (void)viewDidLoad;
- (IBAction)btplus:(id _Nonnull)sender;
- (IBAction)btless:(id _Nonnull)sender;
- (IBAction)btsplit:(id _Nonnull)sender;
- (IBAction)btmultpli:(id _Nonnull)sender;
- (IBAction)btresult:(id _Nonnull)sender;
