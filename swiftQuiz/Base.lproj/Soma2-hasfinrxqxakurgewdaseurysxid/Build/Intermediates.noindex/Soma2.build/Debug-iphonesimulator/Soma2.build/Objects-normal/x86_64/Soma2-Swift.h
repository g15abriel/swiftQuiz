...
#ifndef SOMA2_SWIFT_H
#define SOMA2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Soma2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5Soma211AppDelegate")
...
SWIFT_CLASS("_TtC5Soma213SceneDelegate")
...
SWIFT_CLASS("_TtC5Soma214ViewController")
...
- (void)viewDidLoad;
- (IBAction)btsoma:(UIButton * _Nonnull)sender;
