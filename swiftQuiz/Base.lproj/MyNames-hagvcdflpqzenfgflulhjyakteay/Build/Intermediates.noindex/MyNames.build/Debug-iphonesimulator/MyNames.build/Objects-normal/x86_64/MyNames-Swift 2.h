...
#ifndef MYNAMES_SWIFT_H
#define MYNAMES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MyNames",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7MyNames11AppDelegate")
...
SWIFT_CLASS("_TtC7MyNames13SceneDelegate")
...
SWIFT_CLASS("_TtC7MyNames14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbnames;
- (void)viewDidLoad;
- (IBAction)btName:(UIButton * _Nonnull)sender;
