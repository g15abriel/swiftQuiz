...
#ifndef TESTEBUTTONS_SWIFT_H
#define TESTEBUTTONS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="testeButtons",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12testeButtons11AppDelegate")
...
SWIFT_CLASS("_TtC12testeButtons13SceneDelegate")
...
SWIFT_CLASS("_TtC12testeButtons14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbResult;
@property (nonatomic, copy) IBOutletCollection(UIButton) NSArray<UIButton *> * _Null_unspecified btControll;
- (void)viewDidLoad;
