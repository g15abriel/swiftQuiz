...
#ifndef MYNAME2_SWIFT_H
#define MYNAME2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Myname2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Myname211AppDelegate")
...
SWIFT_CLASS("_TtC7Myname213SceneDelegate")
...
SWIFT_CLASS("_TtC7Myname214ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbName;
- (void)viewDidLoad;
- (IBAction)btName:(id _Nonnull)sender;
