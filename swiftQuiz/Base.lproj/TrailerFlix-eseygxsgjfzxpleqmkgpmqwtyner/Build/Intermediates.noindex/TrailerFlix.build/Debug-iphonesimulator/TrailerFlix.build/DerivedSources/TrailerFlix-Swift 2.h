...
#ifndef TRAILERFLIX_SWIFT_H
#define TRAILERFLIX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TrailerFlix",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11TrailerFlix11AppDelegate")
...
SWIFT_CLASS("_TtC11TrailerFlix23QuestionsViewController")
...
SWIFT_CLASS("_TtC11TrailerFlix13SceneDelegate")
...
SWIFT_CLASS("_TtC11TrailerFlix21TrailerViewController")
@interface TrailerViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbTrailer;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified viTrailer;
- (void)viewDidLoad;
- (IBAction)close:(UIButton * _Nonnull)sender;
- (IBAction)answer:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC11TrailerFlix14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableview;
- (void)viewDidLoad;
- (void)prepareForSegue:(UIStoryboardSegue * _Nonnull)segue sender:(id _Nullable)sender;
- (IBAction)movieClub:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ViewController (SWIFT_EXTENSION(TrailerFlix)) <UITableViewDataSource, UITableViewDelegate>
