...
#ifndef CARETAS_SWIFT_H
#define CARETAS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="caretas",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7caretas11AppDelegate")
...
SWIFT_CLASS("_TtC7caretas13SceneDelegate")
...
SWIFT_CLASS("_TtC7caretas14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified minhaCareta;
- (void)viewDidLoad;
- (IBAction)trocar:(UIButton * _Nonnull)sender;
