...
#ifndef APPDAKAMILY_SWIFT_H
#define APPDAKAMILY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="APPDAKAMILY",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11APPDAKAMILY11AppDelegate")
...
SWIFT_CLASS("_TtC11APPDAKAMILY13SceneDelegate")
...
SWIFT_CLASS("_TtC11APPDAKAMILY14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbhoay;
- (void)viewDidLoad;
- (IBAction)btquestion:(id _Nonnull)sender;
- (IBAction)btim18:(id _Nonnull)sender;
