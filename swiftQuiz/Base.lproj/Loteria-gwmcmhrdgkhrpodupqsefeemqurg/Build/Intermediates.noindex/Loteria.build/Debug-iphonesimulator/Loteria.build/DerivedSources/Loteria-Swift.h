...
#ifndef LOTERIA_SWIFT_H
#define LOTERIA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Loteria",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Loteria11AppDelegate")
...
SWIFT_CLASS("_TtC7Loteria13SceneDelegate")
...
SWIFT_CLASS("_TtC7Loteria14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbTilte;
@property (nonatomic, weak) IBOutlet UISegmentedControl * _Null_unspecified scGameType;
@property (nonatomic, copy) IBOutletCollection(UIButton) NSArray<UIButton *> * _Null_unspecified balls;
- (void)viewDidLoad;
- (IBAction)generateGame;
